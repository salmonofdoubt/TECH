/* LIST1511.c: Day 15 Listing 15.11 */
...
int main(void) {
  ...
  puts("Enter 0 for reverse order sort,"
       " 1 for alphabetical: ");
  scanf("%d", &sort_type);
...
void sort(char *p[], int n, int sort_type) {
  ...
  /* Initialize the pointer to point at the */
  /* proper comparison function depending on */
  /* the argument sort_type. */

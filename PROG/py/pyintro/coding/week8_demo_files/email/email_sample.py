...
def main():
  SendEmail(sender='adsfadfcradfaefadf@google.com',
            recipients='alberthwang@google.com,ethanguo@google.com',
            subject='WHAT IS UP?????!',
            body='Just testing things...')

  """SendEmail(sender='alberthwang@google.com',
            recipients='alberthwang@google.com, smadaan@google.com',
